...
def check_intr():
    try:
        requests.get("https://hritikkumbhar.in/")
    except Exception:
...
def pretty_print(cc,target,success,failed):
    ...
    mesgdcrt.SuccessMessage("Death from Above was created by nordbearbotdev")
def workernode(mode,cc,target,count,delay,max_threads):
    ...
    if len(APIProvider.api_providers)==0:
        ...
        mesgdcrt.GeneralMessage("Feel free to reach out to me")
...
description="""Death from Above [The Advance Bomber]

The uses of Death from Above - 
...
Death from Above is not intented for malicious uses.
"""
