...
def verCheck():
    ...
    ver_url = 'https://raw.githubusercontent.com/nordbearbotdev/Master-Bomber/master/Core/version.txt'
    ...
    if ver_sc == 200:
        ...
        if ver_current == github_ver:
            ...
            sleep(2)
            system("git clone https://github.com/nordbearbotdev/Master-Bomber ../TEMP")
